...
public class MyYuYueAdapter extends XRecyclerView.Adapter<MyYuYueAdapter.MyViewHolder>{

    private Context context;
    private List<YuYueBean.DataBean> list;

    public MyYuYueAdapter(Context context, List<YuYueBean.DataBean> list) {
