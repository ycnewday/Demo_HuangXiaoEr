    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ib_start.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(GuideActivity.this, DengLuActivity.class));
                finish();
            }
        });
...
//            if (i == 0) {
//                iv_point.setBackgroundResource(R.mipmap.loginb);
//            } else {
//                iv_point.setBackgroundResource(R.mipmap.logina);
//            }
    ...
    private void initViewPager() {
        ...
        //实例化图片资源
        imageIdArray = new int[]{R.mipmap.d, R.mipmap.f, R.mipmap.g};
...
//            ivPointArray[position].setBackgroundResource(R.mipmap.loginb);
//            if (position != i) {
//                ivPointArray[i].setBackgroundResource(R.mipmap.logina);
//            }
//        }
